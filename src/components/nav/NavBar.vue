<template>
  <div>
  <div class="Connecter" v-show="connecter">
  <b-navbar  toggleable="lg " type="dark nav" variant="dark" class="navi" flex>
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav >
        <b-navbar-brand href="#"><img src="../../../public/img/Weeb2.png" alt="" class="image" ></b-navbar-brand>
        <b-nav-item href="#">Accueil</b-nav-item>
        <b-nav-item href="/fan_arts">Fan-art</b-nav-item>
        <b-nav-item href="/actu">Actualité</b-nav-item>
        <b-nav-item href="#">Evènements</b-nav-item>
      </b-navbar-nav>
...
<div class="nonConnecter" v-show="nonConnecter">
    <b-navbar  toggleable="lg " type="dark nav" variant="dark" class="navi" flex>
    <b-collapse id="nav-collapse" is-nav>
      <b-navbar-nav >
        <b-navbar-brand href="/"><img src="../../../public/img/Weeb2.png" alt="" class="image" ></b-navbar-brand>
        ...
        <b-nav-item href="/fan_arts">fan-art</b-nav-item>
        <b-nav-item href="/actu">actualité</b-nav-item>
        <b-nav-item href="#">évènements</b-nav-item>
      </b-navbar-nav>
      ...
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right>
          ...
          <b-dropdown-item href="/connexion">Se connecter</b-dropdown-item>
        </b-nav-item-dropdown>
      </b-navbar-nav>
    </b-collapse>
  </b-navbar>
