		...
		<div class="form-v9-content" style="background-image: url('images/form-v9.jpg')">
			<form class="form-detail" action="#" method="post">
				...
				<div class="form-row-total">
					<div class="form-row">
						<input type="text" name="full-name" id="full-name" class="input-text" v-model="pseudo" placeholder="Your Name" required>
					</div>
					<div class="form-row">
						<input type="text" name="your-email" id="your-email" class="input-text" v-model="email" placeholder="Your Email" required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}">
					</div>
				</div>
				<div class="form-row-total">
					<div class="form-row">
						<input type="password" name="password" id="password" class="input-text" v-model="password" placeholder="Your Password" required>
					</div>
				</div>
       ...
       doregister: function (){
            ...
            .then(res =>{
               ...
               if(res.data.token){
                  ...
                  console.log('alpha2');
                    this.$router.push({name: "mailregister", params: {
                      msg: "non connecté", 
                      email: this.email} })
                      console.log('bite2');
                }
